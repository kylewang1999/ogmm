...
def get_parser(): 
    ''' Get an arg parser for jupyter notebooks '''
    ...
    parser.add_argument('--model_path', type=str, default='./results/', metavar='N', help='Name of the experiment')
    ...
    parser.add_argument('--num_workers', type=int, default=8, help='number of processes for data loading')
